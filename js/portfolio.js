...
document.getElementById("backupContact").innerHTML = 'You can always <a href="mailto:' + onload.coverMail() + '">email me here</a> if you are having issues with the form, or prefer email.';
